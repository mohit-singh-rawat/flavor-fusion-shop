    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50">
      ...
      <section className="py-12 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-4">About Sweet & Savory</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p className="text-lg">
                  Sweet & Savory began as a small family bakery in 2009, with a simple mission: to create 
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of satisfied customers who have made Sweet & Savory their go-to choice for special occasions and everyday treats.
          </p>
